...
class ReminderViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        let cellRegistration = UICollectionView.CellRegistration(handler: cellRegistrationHandle)
    ...
    func cellRegistrationHandle(cell: UICollectionViewListCell, indexPath: IndexPath, row: Row) {
    ...
    private func updateSnapshotForViewing() {
        ...
        snapshot.appendItems([Row.header(""), Row.title, Row.date, Row.time, Row.notes])
        dataSource.apply(snapshot)
    }
